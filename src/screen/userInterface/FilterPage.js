...
export default function FilterPage(props) {
  ...
  var subcategoryid = "";
  try {
    if (location?.state?.subcategoryid == undefined) subcategoryid = null;
    else subcategoryid = location?.state?.subcategoryid;
  } catch (e) {
    {
      subcategoryid = null;
    }
  ...
  return (
    <Grid
      container
      spacing={2}
      style={{ width: "100%", fontFamily: "kanit", display: "flex" }}
    >
