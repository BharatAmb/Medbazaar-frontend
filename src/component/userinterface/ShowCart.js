...
export default function ShowCart(props) {
            ...
            <Grid item xs={2}>
              <div
                style={{
                  ...
                  margin: 3,
                  boxShadow: "1px 1px 10px #f7f1e3",
                }}
              >
                <img
                  src={`${serverURL}/images/${item.picture}`}
                  style={{ width: "75%", borderRadius: 10, height: "100px" }}
                />
              </div>
            </Grid>
            <Grid item xs={8} margin={1}>
              <div style={{ fontSize: matchesMd ? "1.0em" : "1.3em" }}>
              ...
              <div style={{ fontWeight: "bold", marginBottom: 12 }}>
                ...
                &#x20B9;{item.price}
                <span
                  style={{ display: "flex", width: "45%", marginLeft: "auto" }}
                >
                  {" "}
                  <PlusMinusComponent
                    qty={item?.qty}
              ...
              >
                ...
                Remove{" "}
                <span style={{ color: "black", paddingLeft: 45 }}>
                  <BookmarkAddOutlinedIcon />
                </span>
                <span style={{ color: "black" }}>Add to favourite</span>
              </div>
            </Grid>
            <Divider />
            <Grid item xs={2}></Grid>
  ...
  return (
    <div style={{ fontFamily: "kanit" }}>
      ...
      <div style={{ margin: 20 }}>{CartItems()}</div>
