...
export default function ProductInformation(props) {
  ...
  return (
    <div style={{ display: "flex", marginLeft: 20, width: "100%" }}>
        ...
        <Grid item xs={12}>
          <Grid item xs={12} className={classes.grid2}>
            <div>
              ...
              {showDescription()}
              <div className={classes.divBrandname}>
                {" "}
                {product?.brandname}
                <CircleIcon
                  style={{ fontSize: 8, marginLeft: 10, marginRight: 10 }}
                />{" "}
                {product?.weight} {product?.weighttype}
              ...
              <span className={classes.span1}>
                <WatchLaterOutlinedIcon style={{ marginRight: 6 }} />
                Delivery within 2 hrs
              </span>
