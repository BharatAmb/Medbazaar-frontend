      ...
      <Paper>
        ...
        <div>
          <List>
            ...
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => navigate("/dashboard/displayproductdetails")}
              >
                <ListItemIcon>
                  <DraftsIcon />
                </ListItemIcon>
  ...
  return (
    <div style={{ display: "flex", width: "100vw" }}>
      <Box sx={{ flexGrow: 1, position: "relative" }} onMouseLeave={hidecart}>
        ...
        <div>{matches ? seconderySearchBar() : <div></div>}</div>

        <Drawer anchor="left" open={status} onClose={handleDrawerClose}>
          {DrawerList()}
        </Drawer>
